package com.example.xianwalletapp.ui.theme
...
val XianGreen = Color(0xFF4CAF50)      // Vibrant green for success and instructions
...
val XianSecondaryText = XianGreen       // Green for secondary text
